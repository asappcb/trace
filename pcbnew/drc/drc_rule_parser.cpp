...
void DRC_RULES_PARSER::parseConstraint( DRC_RULE* aRule )
{
    ...
    case T_backdrill_clearance:       c.m_Type = BACKDRILL_CLEARANCE_CONSTRAINT;       break;
    case T_backdrill_hole_to_hole:    c.m_Type = BACKDRILL_HOLE_TO_HOLE_CONSTRAINT;    break;
    ...
    default:
        expected( wxT( "assertion, clearance, hole_clearance, edge_clearance, physical_clearance, "
                       ...
                       "backdrill_stub_length, backdrill_clearance, backdrill_hole_to_hole, skew, "
                       "via_count, via_dangling, via_diameter, diff_pair_gap, diff_pair_uncoupled or "
                       "bridged_mask" ) );
        return;
    }
