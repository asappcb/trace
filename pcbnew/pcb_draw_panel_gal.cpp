...
const int GAL_LAYER_ORDER[] = {
    ...
    ZONE_LAYER_FOR( Margin ), POINT_LAYER_FOR( Margin ),

    User_1, ZONE_LAYER_FOR( User_1 ), POINT_LAYER_FOR( User_1 ), User_2, ZONE_LAYER_FOR( User_2 ),
    POINT_LAYER_FOR( User_2 ), User_3, ZONE_LAYER_FOR( User_3 ), POINT_LAYER_FOR( User_3 ), User_4,
    ZONE_LAYER_FOR( User_4 ), POINT_LAYER_FOR( User_4 ), User_5, ZONE_LAYER_FOR( User_5 ), POINT_LAYER_FOR( User_5 ),
    User_6, ZONE_LAYER_FOR( User_6 ), POINT_LAYER_FOR( User_6 ), User_7, ZONE_LAYER_FOR( User_7 ),
    POINT_LAYER_FOR( User_7 ), User_8, ZONE_LAYER_FOR( User_8 ), POINT_LAYER_FOR( User_8 ), User_9,
    ZONE_LAYER_FOR( User_9 ), POINT_LAYER_FOR( User_9 ), User_10, ZONE_LAYER_FOR( User_10 ), POINT_LAYER_FOR( User_10 ),
    ...
    ZONE_LAYER_FOR( User_14 ), POINT_LAYER_FOR( User_14 ), User_15, ZONE_LAYER_FOR( User_15 ),
    POINT_LAYER_FOR( User_15 ), User_16, ZONE_LAYER_FOR( User_16 ), POINT_LAYER_FOR( User_16 ), User_17,
    ZONE_LAYER_FOR( User_17 ), POINT_LAYER_FOR( User_17 ), User_18, ZONE_LAYER_FOR( User_18 ),
    POINT_LAYER_FOR( User_18 ), User_19, ZONE_LAYER_FOR( User_19 ), POINT_LAYER_FOR( User_19 ), User_20,
    ZONE_LAYER_FOR( User_20 ), POINT_LAYER_FOR( User_20 ), User_21, ZONE_LAYER_FOR( User_21 ),
    POINT_LAYER_FOR( User_21 ), User_22, ZONE_LAYER_FOR( User_22 ), POINT_LAYER_FOR( User_22 ), User_23,
    ZONE_LAYER_FOR( User_23 ), POINT_LAYER_FOR( User_23 ), User_24, ZONE_LAYER_FOR( User_24 ),
    POINT_LAYER_FOR( User_24 ), User_25, ZONE_LAYER_FOR( User_25 ), POINT_LAYER_FOR( User_25 ), User_26,
    ZONE_LAYER_FOR( User_26 ), POINT_LAYER_FOR( User_26 ), User_27, ZONE_LAYER_FOR( User_27 ),
    POINT_LAYER_FOR( User_27 ), User_28, ZONE_LAYER_FOR( User_28 ), POINT_LAYER_FOR( User_28 ), User_29,
    ZONE_LAYER_FOR( User_29 ), POINT_LAYER_FOR( User_29 ), User_30, ZONE_LAYER_FOR( User_30 ),
    POINT_LAYER_FOR( User_30 ), User_31, ZONE_LAYER_FOR( User_31 ), POINT_LAYER_FOR( User_31 ), User_32,
    ZONE_LAYER_FOR( User_32 ), POINT_LAYER_FOR( User_32 ), User_33, ZONE_LAYER_FOR( User_33 ),
    POINT_LAYER_FOR( User_33 ), User_34, ZONE_LAYER_FOR( User_34 ), POINT_LAYER_FOR( User_34 ), User_35,
    ZONE_LAYER_FOR( User_35 ), POINT_LAYER_FOR( User_35 ), User_36, ZONE_LAYER_FOR( User_36 ),
    POINT_LAYER_FOR( User_36 ), User_37, ZONE_LAYER_FOR( User_37 ), POINT_LAYER_FOR( User_37 ), User_38,
    ZONE_LAYER_FOR( User_38 ), POINT_LAYER_FOR( User_38 ), User_39, ZONE_LAYER_FOR( User_39 ),
    POINT_LAYER_FOR( User_39 ), User_40, ZONE_LAYER_FOR( User_40 ), POINT_LAYER_FOR( User_40 ), User_41,
    ZONE_LAYER_FOR( User_41 ), POINT_LAYER_FOR( User_41 ), User_42, ZONE_LAYER_FOR( User_42 ),
    POINT_LAYER_FOR( User_42 ), User_43, ZONE_LAYER_FOR( User_43 ), POINT_LAYER_FOR( User_43 ), User_44,
    ZONE_LAYER_FOR( User_44 ), POINT_LAYER_FOR( User_44 ), User_45, ZONE_LAYER_FOR( User_45 ),
    POINT_LAYER_FOR( User_45 ),
    ...
    CLEARANCE_LAYER_FOR( In1_Cu ), POINT_LAYER_FOR( In1_Cu ), In1_Cu, ZONE_LAYER_FOR( In1_Cu ),
    NETNAMES_LAYER_INDEX( In2_Cu ), PAD_COPPER_LAYER_FOR( In2_Cu ), VIA_COPPER_LAYER_FOR( In2_Cu ),
    CLEARANCE_LAYER_FOR( In2_Cu ), POINT_LAYER_FOR( In2_Cu ), In2_Cu, ZONE_LAYER_FOR( In2_Cu ),
    NETNAMES_LAYER_INDEX( In3_Cu ), PAD_COPPER_LAYER_FOR( In3_Cu ), VIA_COPPER_LAYER_FOR( In3_Cu ),
    CLEARANCE_LAYER_FOR( In3_Cu ), POINT_LAYER_FOR( In3_Cu ), In3_Cu, ZONE_LAYER_FOR( In3_Cu ),
    NETNAMES_LAYER_INDEX( In4_Cu ), PAD_COPPER_LAYER_FOR( In4_Cu ), VIA_COPPER_LAYER_FOR( In4_Cu ),
    CLEARANCE_LAYER_FOR( In4_Cu ), POINT_LAYER_FOR( In4_Cu ), In4_Cu, ZONE_LAYER_FOR( In4_Cu ),
    NETNAMES_LAYER_INDEX( In5_Cu ), PAD_COPPER_LAYER_FOR( In5_Cu ), VIA_COPPER_LAYER_FOR( In5_Cu ),
    CLEARANCE_LAYER_FOR( In5_Cu ), POINT_LAYER_FOR( In5_Cu ), In5_Cu, ZONE_LAYER_FOR( In5_Cu ),
    NETNAMES_LAYER_INDEX( In6_Cu ), PAD_COPPER_LAYER_FOR( In6_Cu ), VIA_COPPER_LAYER_FOR( In6_Cu ),
    CLEARANCE_LAYER_FOR( In6_Cu ), POINT_LAYER_FOR( In6_Cu ), In6_Cu, ZONE_LAYER_FOR( In6_Cu ),
    NETNAMES_LAYER_INDEX( In7_Cu ), PAD_COPPER_LAYER_FOR( In7_Cu ), VIA_COPPER_LAYER_FOR( In7_Cu ),
    CLEARANCE_LAYER_FOR( In7_Cu ), POINT_LAYER_FOR( In7_Cu ), In7_Cu, ZONE_LAYER_FOR( In7_Cu ),
    NETNAMES_LAYER_INDEX( In8_Cu ), PAD_COPPER_LAYER_FOR( In8_Cu ), VIA_COPPER_LAYER_FOR( In8_Cu ),
    CLEARANCE_LAYER_FOR( In8_Cu ), POINT_LAYER_FOR( In8_Cu ), In8_Cu, ZONE_LAYER_FOR( In8_Cu ),
    NETNAMES_LAYER_INDEX( In9_Cu ), PAD_COPPER_LAYER_FOR( In9_Cu ), VIA_COPPER_LAYER_FOR( In9_Cu ),
    CLEARANCE_LAYER_FOR( In9_Cu ), POINT_LAYER_FOR( In9_Cu ), In9_Cu, ZONE_LAYER_FOR( In9_Cu ),
    ...
    CLEARANCE_LAYER_FOR( B_Cu ), POINT_LAYER_FOR( B_Cu ), B_Cu, ZONE_LAYER_FOR( B_Cu ), B_Mask,
    ZONE_LAYER_FOR( B_Mask ), B_SilkS, ZONE_LAYER_FOR( B_SilkS ), B_Paste, ZONE_LAYER_FOR( B_Paste ), B_Adhes,
    ZONE_LAYER_FOR( B_Adhes ), B_CrtYd, ZONE_LAYER_FOR( B_CrtYd ), B_Fab, ZONE_LAYER_FOR( B_Fab ),

    BITMAP_LAYER_FOR( Dwgs_User ), BITMAP_LAYER_FOR( Cmts_User ), BITMAP_LAYER_FOR( Eco1_User ),
    BITMAP_LAYER_FOR( Eco2_User ), BITMAP_LAYER_FOR( Edge_Cuts ), BITMAP_LAYER_FOR( Margin ),
