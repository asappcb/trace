...
types::ConstraintType ToProtoEnum( PCB_CONSTRAINT_TYPE aValue )
{
    ...
    default:
        wxCHECK_MSG( false, types::ConstraintType::CT_UNKNOWN, "Unhandled case in ToProtoEnum<PCB_CONSTRAINT_TYPE>" );
    }
}
...
PCB_CONSTRAINT_TYPE FromProtoEnum( types::ConstraintType aValue )
{
    ...
    default:
        wxCHECK_MSG( false, PCB_CONSTRAINT_TYPE::UNDEFINED, "Unhandled case in FromProtoEnum<types::ConstraintType>" );
    }
}
...
types::ConstraintAnchor ToProtoEnum( CONSTRAINT_ANCHOR aValue )
{
    ...
    default:
        wxCHECK_MSG( false, types::ConstraintAnchor::CA_UNKNOWN, "Unhandled case in ToProtoEnum<CONSTRAINT_ANCHOR>" );
    }
}
...
CONSTRAINT_ANCHOR FromProtoEnum( types::ConstraintAnchor aValue )
{
    ...
    default: wxCHECK_MSG( false, CONSTRAINT_ANCHOR::WHOLE, "Unhandled case in FromProtoEnum<types::ConstraintAnchor>" );
    }
}
